...
class Actor(nn.Module):
    def __init__(self, state_dim, action_dim, device):
        ...
        self.l2 = nn.Linear(hidden_dim, hidden_dim_1)
        self.l3 = nn.Linear(hidden_dim_1, action_dim)

        self.bn1 = nn.BatchNorm1d(hidden_dim)
        self.bn2 = nn.BatchNorm1d(hidden_dim_1)
...
class Critic(nn.Module):
    def __init__(self, state_dim, action_dim):
        ...
        hidden_dim_1 = 350
        self.l1 = nn.Linear(state_dim, hidden_dim)
        self.l2 = nn.Linear(hidden_dim + action_dim, hidden_dim_1)
        self.l3 = nn.Linear(hidden_dim_1, 1)
